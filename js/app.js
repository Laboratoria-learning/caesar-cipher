/* Creamos función que determina si ejecuta función cipher o función descipher*/
function executeCaesar() {
  ...
  do { // Utilizamos bucle do while para que el prompt se ejecute primero al menos una vez
    // La respuesta al prompt se asignará como valor de userAnswer
    userAnswer = prompt('Ingrese 1 si desea cifrar o 2 si desea descifrar');

    // Si se cumple condición (userAnswer no es cadena vacía) entonces...
    if (userAnswer !== '') {
    ...
    /* Siempre que userAnswer sea una cadena vacía o un número diferente a 1 o 2 devolverá de nuevo
     el prompt inicial */
...
var cipher = function(userPhrase) { // Definimos función cipher para cifrar una frase (opción 1)
  do {
    // Asignamos la respuesta de prompt como valor de userPhrase
    userPhrase = prompt('Por favor ingrese una frase:');

    /* Creamos variable cuyo valor es una cadena vacía que posteriormente almanecenará la
       frase cifrada */
    var newCipherPhrase = '';
