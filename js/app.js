...
// si el texto es diferente de 0, o si ingresa algun valor númerico lo reemplaza por vacio y vuelve a llamar al prompt]
...
// llamamos a la funcion a ejecutar
  ...
  // si lo anterior no se cumple, se llamara nuevamente al prompt
  alert('Error vuelva a ingresar la frase'); 
  var text = prompt('Ingrese la frase a encriptar');
}  
